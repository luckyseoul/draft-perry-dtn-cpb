...
def main():
    ...
    # Paired comparison
    print()
    print("=== paired comparison (cpb - baseline), 10 seeds ===")
    ...
    print(f"delivery: mean={md:+.5f}  sd={sd:.5f}  t={t:+.2f}  "
          f"(n=10, df=9; |t|>3.250 is p<0.01 two-tailed)")
    ...
    # CSV
    out_path = Path("/home/nick/dtn/cpb/config1_results.csv")
