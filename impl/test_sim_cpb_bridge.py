"""Bridge tests: local confidence values through the CPB wire format.
...
local confidence values through the specified encoding. These tests
...
test coverage without end-to-end routing claims.
"""
